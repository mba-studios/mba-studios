...
cena1.create = function () {
    ...
    this.physics.add.collider(player1, platforms, null, this);
    this.physics.add.collider(player2, platforms, null, this);
    this.physics.add.collider(water, platforms, null, this);
    this.physics.add.collider(water2, platforms, null, this);
    this.physics.add.collider(water3, platforms, null, this);
    this.physics.add.collider(gate, platforms, null, this);
